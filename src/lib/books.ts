...
export const books: Book[] = [
  { title: "Assassin's Apprentice", author: "Robin Hobb", status: "read", rating: 8, date: "2026-05-15", year: 2026, genre: ["Fantasy"] },
  ...
  { title: "Blood Meridian", author: "Cormac McCarthy", status: "read", rating: 5, date: "2026-03-15", year: 2026, genre: ["Skönlitteratur", "Western"] },
  ...
  { title: "A Darkness at Sethanon", author: "Raymond E. Feist", status: "read", rating: 6, date: "2025-10-01", year: 2025, genre: ["Fantasy"] },
  { title: "Silverthorn", author: "Raymond E. Feist", status: "read", rating: 6, date: "2025-09-23", year: 2025, genre: ["Fantasy"] },
  { title: "What I Talk About When I Talk About Running", author: "Haruki Murakami", status: "read", rating: 6, date: "2025-09-13", year: 2025, genre: ["Memoar", "Essä"] },
  { title: "Magician", author: "Raymond E. Feist", status: "read", rating: 7, date: "2025-09-07", year: 2025, genre: ["Fantasy"] },
  ...
  { title: "Heartburn", author: "Nora Ephron", status: "read", rating: null, date: "2025-05-29", year: 2025, genre: ["Skönlitteratur", "Humor"] },
  { title: "Only Dull People Are Brilliant at Breakfast", author: "Oscar Wilde", status: "read", rating: 3, date: "2025-04-01", year: 2025, genre: ["Essä", "Klassiker"] },
  { title: "Big Panda & Tiny Dragon", author: "James Norbury", status: "read", rating: 8, date: "2025-03-28", year: 2025, genre: ["Filosofi"] },
  ...
  { title: "On Consolation: Finding Solace in Dark Times", author: "Michael Ignatieff", status: "read", rating: null, date: "2024-11-07", year: 2024, genre: ["Essä", "Filosofi"] },
  ...
  { title: "Humankind: A Hopeful History", author: "Rutger Bregman", status: "wanted", rating: null, genre: ["Facklitteratur", "Historia"] },
];
